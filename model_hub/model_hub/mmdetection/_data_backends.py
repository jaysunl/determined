...
def sub_backend(
    ...
    """
    Replaces the `file_client_args` field of calls to `LoadImageFromFile` with the
    provided dictionary.  `file_client_args` should be a dictionary with a `backend` specified
    along with keyword arguments to instantiate the backend.
